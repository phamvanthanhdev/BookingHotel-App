...
import com.example.hotelbookingapplication.Common;
...
public class HotelVerticalAdapter extends RecyclerView.Adapter<HotelVerticalAdapter.RecentsViewHolder>{
    ...
    @NonNull
    @Override
    public HotelVerticalAdapter.RecentsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HotelVerticalAdapter.RecentsViewHolder holder, int position) {
